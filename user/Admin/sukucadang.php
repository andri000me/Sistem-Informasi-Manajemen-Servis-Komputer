...
<body id="page-top">
  ...
  <div id="wrapper">
                        ...
                        while($data = mysqli_fetch_array($query)){
                          ...
                          <tr>
                            ...
                            <th>
                              ...
                              <!-- IKI BAGIAN SING NGGO TRIGGER MODAL KARO NGIRRIM VARIABEL PHP NING TABEL NYANG MODAL -->
    ...
    <!-- CUSTOM JAVASCRIPT -->
    <!-- IKI JAVASCRIPT NGGO NANGKEP VARIABEL SEKO TABEL TERUS DIKIRIM NYANG MODAL -->
    <script
