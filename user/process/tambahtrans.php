<?php 
	...
	$queryTambahServis = mysqli_query($koneksi,"INSERT INTO barang (id_barang, nama, keluhan, pelanggan, notelp_pel, tgl_masuk, status, kode, username, id_teknisi) VALUES ('', '$barang', '$keluhan', '$pelanggan', '$telepon', now(), '$status', '$kodebaru', '$username', $idteknisi)");
